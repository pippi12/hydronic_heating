...
<li>
  ...
  connect(jun_sup_hal1.port_3, pips_kit_31.port_a1) annotation(
      Line(points = {{40, -98}, {64, -98}}, color = {0, 127, 255}));
  connect(pips_kit_31.port_b1, rad_hal1.port_a) annotation(
      Line(points = {{84, -98}, {112, -98}, {112, -102}}, color = {0, 127, 255}));
  annotation(
